    ...
    return {
        ...
        ...(l.LOCALITY_CLASS_CODE !== "" && {
            class: {
                ...
                name: (0, propertyCodeToName_1.localityClassCodeToName)(l.LOCALITY_CLASS_CODE, context),
            },
        }),
    };
};
 ...
 */
const mapStreetLocality = (l, context) => {
    return {
        ...(l.STREET_NAME !== "" && {
            name: l.STREET_NAME,
        }),
        ...(l.STREET_TYPE_CODE !== "" && {
            type: {
                ...
                name: (0, propertyCodeToName_1.streetTypeCodeToName)(l.STREET_TYPE_CODE, context, l),
            },
        }),
        ...(l.STREET_CLASS_CODE !== "" && {
            class: {
                code: l.STREET_CLASS_CODE,
                name: (0, propertyCodeToName_1.streetClassCodeToName)(l.STREET_CLASS_CODE, context, l),
            },
        }),
        ...(l.STREET_SUFFIX_CODE !== "" && {
            suffix: {
                code: l.STREET_SUFFIX_CODE,
                name: (0, propertyCodeToName_1.streetSuffixCodeToName)(l.STREET_SUFFIX_CODE, context),
            },
        }),
    };
};
exports.mapStreetLocality = mapStreetLocality;
/**
 ...
 */
const mapGeo = (geoSite, context, geoDefault) => {
    let foundDefault = false;
    if (geoSite && geoDefault) {
        for (const geo of geoSite) {
            if (geo.GEOCODE_TYPE_CODE === geoDefault[0].GEOCODE_TYPE_CODE &&
    ...
    const sites = geoSite
            ...
            return {
                ...
                ...(geo.GEOCODE_TYPE_CODE !== "" && {
                    type: {
                        ...
                        name: (0, propertyCodeToName_1.geocodeTypeCodeToName)(geo.GEOCODE_TYPE_CODE, context),
                    },
                }),
                ...(geo.RELIABILITY_CODE !== "" && {
                    reliability: {
                        code: geo.RELIABILITY_CODE,
                        name: (0, propertyCodeToName_1.geocodeReliabilityCodeToName)(geo.RELIABILITY_CODE, context),
                    },
                }),
                ...(geo.LATITUDE !== "" && {
        ...
        : [];
    const def = geoDefault && !foundDefault
        ? geoDefault.map((geo) => {
            return {
                default: true,
                ...(geo.GEOCODE_TYPE_CODE !== "" && {
...
exports.mapToShortMla = mapToShortMla;
/**
 ...
 */
// eslint-disable-next-line complexity
const mapAddressDetails = (d, context, i, count) => {
    ...
    const geoDefault = context.geoDefaultIndexed
        ...
        : undefined;
    const hasGeo = d.LEVEL_GEOCODED_CODE !== "" &&
        ((geoSite !== undefined && geoSite.length > 0) ||
            (geoDefault !== undefined && geoDefault.length > 0));
    const geocoding = d.LEVEL_GEOCODED_CODE !== "" && hasGeo
        ? {
            ...(d.LEVEL_GEOCODED_CODE !== "" && {
                level: {
                    code: d.LEVEL_GEOCODED_CODE,
                    name: (0, propertyCodeToName_1.levelGeocodedCodeToName)(d.LEVEL_GEOCODED_CODE, context),
                },
            }),
            ...(hasGeo && {
                geocodes: (0, exports.mapGeo)(geoSite, context, geoDefault),
            }),
        }
        : undefined;
    const structured = {
            ...
            level: {
                ...(d.LEVEL_TYPE_CODE !== "" && {
                    type: {
                        ...
                        name: (0, propertyCodeToName_1.levelTypeCodeToName)(d.LEVEL_TYPE_CODE, context, d),
                    },
                }),
                ...(d.LEVEL_NUMBER_PREFIX !== "" && {
            ...
            flat: {
                ...(d.FLAT_TYPE_CODE !== "" && {
                    type: {
                        ...
                        name: (0, propertyCodeToName_1.flatTypeCodeToName)(d.FLAT_TYPE_CODE, context, d),
                    },
                }),
                ...(d.FLAT_NUMBER_PREFIX !== "" && {
        ...
        street: (0, exports.mapStreetLocality)(streetLocality, context),
        ...(d.CONFIDENCE !== "" && {
            confidence: Number.parseInt(d.CONFIDENCE),
        }),
        locality: (0, exports.mapLocality)(locality, context),
        ...(d.POSTCODE !== "" && {
            postcode: d.POSTCODE,
        }),
        ...((d.LOT_NUMBER_PREFIX !== "" ||
    ...
    const precedence = d.PRIMARY_SECONDARY !== ""
        ? d.PRIMARY_SECONDARY === "P"
            ? "primary"
            : "secondary"
        : undefined;
    const mla = (0, exports.mapToMla)(structured);
    const smla = structured.flat !== undefined ? (0, exports.mapToShortMla)(structured) : undefined;
    const rval = {
        ...(geocoding ? { geocoding } : {}),
        structured,
        ...
        mla,
        sla: (0, exports.mapToSla)(mla),
        ...(smla ? { smla, ssla: (0, exports.mapToSla)(smla) } : {}),
    };
    if (count) {
        if (i &&
...
const mapAuthCodeTableToSynonymList = (table) => {
    return table
        .filter((type) => type.CODE !== type.NAME)
        .map((type) => `${type.CODE} => ${type.NAME}`);
};
exports.mapAuthCodeTableToSynonymList = mapAuthCodeTableToSynonymList;
