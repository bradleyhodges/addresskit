...
const {
    dropIndex: dropESIndex,
    initIndex,
} = require("@repo/addressr-client/elasticsearch");
const download = require("@repo/addressr-core/utils/stream-down").default;
...
const { setLinkOptions } = require("./setLinkOptions");
...
async function loadGnaf({ refresh = false } = {}) {
